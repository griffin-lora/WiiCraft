...
void character_handle_input(vec3s cam_look, vec3w_t last_wpad_accel, vec3w_t last_nunchuk_accel, us_t now, f32 delta, vec3w_t wpad_accel, vec2s nunchuk_vector, u8 nunchuk_buttons_down, vec3w_t nunchuk_accel);
