...
namespace game {
    ...
    #define TINTED_DECAL_FACE_PARAMS M& ms_st, math::vector3u8 pos, math::vector3u8 offset_pos, math::vector3u8 color, math::vector2u8 uv_0, math::vector2u8 offset_uv_0, math::vector2u8 uv_1, math::vector2u8 offset_uv_1
    #define SHORT_TINTED_DECAL_FACE_PARAMS M& ms_st, math::vector3u8 p, math::vector3u8 po, math::vector3u8 c, math::vector2u8 u0, math::vector2u8 uo0, math::vector2u8 u1, math::vector2u8 uo1
    ...
    ADD_FACE_TEMPLATE void add_flat_tinted_decal_front_vertices(TINTED_DECAL_FACE_PARAMS);
    ADD_FACE_TEMPLATE void add_flat_tinted_decal_back_vertices(TINTED_DECAL_FACE_PARAMS);
    ADD_FACE_TEMPLATE void add_flat_tinted_decal_top_vertices(TINTED_DECAL_FACE_PARAMS);
    ADD_FACE_TEMPLATE void add_flat_tinted_decal_bottom_vertices(TINTED_DECAL_FACE_PARAMS);
    ADD_FACE_TEMPLATE void add_flat_tinted_decal_right_vertices(TINTED_DECAL_FACE_PARAMS);
    ADD_FACE_TEMPLATE void add_flat_tinted_decal_left_vertices(TINTED_DECAL_FACE_PARAMS);
    ...
    template<block::face FACE, typename L, typename M>
    constexpr void add_flat_tinted_decal_face_vertices(TINTED_DECAL_FACE_PARAMS) {
        call_face_func_for<FACE, void>(
            add_flat_tinted_decal_front_vertices<L, M>,
            add_flat_tinted_decal_back_vertices<L, M>,
            add_flat_tinted_decal_top_vertices<L, M>,
            add_flat_tinted_decal_bottom_vertices<L, M>,
            add_flat_tinted_decal_right_vertices<L, M>,
            add_flat_tinted_decal_left_vertices<L, M>,
            ms_st, pos, offset_pos, color, uv_0, offset_uv_0, uv_1, offset_uv_1
        );
    }
}