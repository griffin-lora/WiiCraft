...
namespace game {
    ...
    void add_block_vertices(math::vector3u8 local_position, block::type type) {
        add_face_vertices<block::face::FRONT, Vf>(local_position, type);
        add_face_vertices<block::face::BACK, Vf>(local_position, type);
        add_face_vertices<block::face::TOP, Vf>(local_position, type);
        add_face_vertices<block::face::BOTTOM, Vf>(local_position, type);
        add_face_vertices<block::face::RIGHT, Vf>(local_position, type);
        add_face_vertices<block::face::LEFT, Vf>(local_position, type);
        // TODO: make this work
